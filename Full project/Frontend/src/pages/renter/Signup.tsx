...
import { useRenterSignUpMutation } from '../../store/service/renterApi';
...
const SignUp = () => {
  ...
  const [renterSignUp, { isLoading, error }] = useRenterSignUpMutation();

  // Handle form submission
  const onSubmit = async (data: SignUpFormData) => {
    try {
      // Replace this with actual API call for user sign-up
      const response = await renterSignUp({ ...data, role: 'USER' }).unwrap();
